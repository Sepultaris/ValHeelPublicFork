...
namespace ACE.Server.Factories.Tables
{
    public static class SpellLevelChance
    {
        ...
        */
        ...
        private static ChanceTable<int> T10_SpellLevelChances = new ChanceTable<int>()
        {
            ( 6, 0.00f ),
            ( 7, 0.00f ),
            ( 8, 1.00f ),
        ...
        private static ChanceTable<int> T11_SpellLevelChances = new ChanceTable<int>()
        {
            ( 6, 0.00f ),
            ( 7, 0.00f ),
            ( 8, 1.00f ),
