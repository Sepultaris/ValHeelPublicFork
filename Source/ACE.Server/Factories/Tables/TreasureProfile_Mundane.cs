...
namespace ACE.Server.Factories.Tables
{
    public static class TreasureProfile_Mundane
    {
        ...
        {
            ( TreasureItemType_Orig.Pyreal,         0.20f ),
            ( TreasureItemType_Orig.Consumable,     0.20f ),
            ( TreasureItemType_Orig.HealKit,        0.20f ),
            ( TreasureItemType_Orig.Lockpick,       0.20f ),
            ( TreasureItemType_Orig.ManaStone,      0.20f ),
        };
